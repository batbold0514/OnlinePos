		...
		if (rowList != null && rowList.size() > 0)
		{
			...
			for (Row row : rowList)
	    	{
				if (row.getCellList() != null && row.getCellList().size() > 0)
	    		{
					...
					tableBody = tableBody + "<td>"+count+"</td>";
		    		for (Cell cell : row.getCellList())
		    		{
		    			...
		    			{
		    				case "order_date":
		    					tableBody = tableBody + "<td>" + cell.getValue().substring(0,19) + "</td>";
		    					break;
		    				case "order_num":
		    				...
		    				case "type":
		    					...
		    					case "Card":
		    						tableBody = tableBody + "<td>Картаар</td>";
		    						break;
		    					case "Cash":
		    						tableBody = tableBody + "<td>Бэлнээр</td>";
		    						break;
		    					default:
		    						tableBody = tableBody + "<td>Нэхэмжлэхээр</td>";
			    					break;
		    					}
		    					break;
		    				default:
