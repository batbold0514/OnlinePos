		    ...
		    <div class="main-container container" id="main-container">
	        					...
	        					<div class="col-sm-12">
	        						<form action="search-sales" class="form-horizontal" method="POST">
	        							...
	        							<div class="row">
	        								...
	        								<div class = "col-sm-1">
	        									<a href ="#" class="btn btn-sm btn-block" tabindex = "5"  id="print">
	        										Хэвлэх
	        									</a>
	        								</div>
	        								<div class="col-sm-1">
	        									<a href ="cash.jsp" class="btn btn-sm btn-danger btn-block" tabindex = "6"  id="back">
	        										Буцах
	        									</a>
	        								</div>
	        							</div>
	        	...
	        	<div id ="printPage" class = "hide">
	        		<table class="table table-striped table-bordered table-hover" border="1px">
          			...
          			<div class="12 text-center blue" align="right">
          				<h2>
          					<b>Нийт : ${total}</b>
          				</h2>
          			</div>
