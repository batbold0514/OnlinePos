...
//				display(message);
		...
		private void checkMessage(String message) throws SQLException {
		...
		private void call(String message) {
			String[] str = message.split("-");
			test.call(str[1], str[2], str[3],str[4]);
		}

		private void answer() throws SQLException {
			test.answer();
		}
