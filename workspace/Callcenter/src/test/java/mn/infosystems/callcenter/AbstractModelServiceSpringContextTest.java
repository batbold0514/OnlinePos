package mn.infosystems.callcenter;
...
public abstract class AbstractModelServiceSpringContextTest extends AbstractSingleSpringContextTests {
    ...
    protected static final String[] CONTEXTFILES_TO_LOAD = { "classpath:/spring-context-callcenter.xml" };
    ...
    public PlatformTransactionManager getTransactionManager() {
        if (transactionManager == null) {
            this.transactionManager = (PlatformTransactionManager) getApplicationContext()
