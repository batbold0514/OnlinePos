...
<div class="row">
	<div class="col-md-12">
		<h3 class="page-title">
			<s:text name="connected-people" />
		</h3>
	</div>
	<div class="portlet box blue">
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-tags"> <s:text name="connected-people" /></i>
			</div>
			<div class="tools">
				...
				<div class="row">
					<div class="col-sm-12">
						<label for="min" class="control-label col-sm-5 col-lg-5">
							<s:text name="personDescription" />:
						</label>
						<div class="col-sm-7 col-lg-6">
							<s:textfield name="personDescription" cssClass="form-control" autofocus=""
								disabled="true" />
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-12">
						<label for="description" class="control-label col-sm-5 col-lg-5">
							<s:text name="returnDescription" />:
						</label>
						<div class="col-sm-7 col-lg-6">
							<s:textfield name="personDescription" cssClass="form-control" rows="2"
								autofocus="" />
						</div>
					</div>
				</div>
...
<script src="../js/PageJS/connectedPerson.js"></script>