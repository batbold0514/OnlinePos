...
<div class="row">
	<div class="col-md-12">
		<h3 class="page-title">
			<s:text name="returnReason" />
		</h3>
	</div>
	<div class="portlet box blue">
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-tags"> <s:text name="returnReason" /></i>
			</div>
			<div class="tools">
			...
			<div class="form-group">
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="col-sm-7 col-lg-6">
							<s:textfield name="description" cssClass="form-control" rows="2"
								autofocus="" />
						</div>
					</div>
				</div>
...
<script src="../js/PageJS/returnReason.js"></script>