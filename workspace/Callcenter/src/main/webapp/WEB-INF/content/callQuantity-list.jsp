...
<div class="row">
	<div class="col-md-12">
		<h3 class="page-title">
			<s:text name="callQuantitys" />
		</h3>
	</div>
	<div class="portlet box blue">
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-tags"> <s:text name="callQuantitys" /></i>
			</div>
			<div class="tools">
		...
		<div class="portlet-body">
			...
			<div id="list-result">
				<display:table name="listOfCallQuantity" id="callQuantityTable"
					class="display table-hover table-bordered">
					<display:column property="id" title="ID" />
					<display:column property="count" title="Тоо" />
				</display:table>
			</div>
		</div>
	</div>
			...
			<div class="form-group">
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="col-sm-7 col-lg-6">
							<s:textfield name="count" cssClass="form-control" autofocus="" id = "callQuantityFrom"/>
						</div>
					</div>
				</div>
			</div>
...
<script src="../js/PageJS/callQuantity.js"></script>