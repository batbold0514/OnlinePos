...
function initValidator(){
	$('#addform').bootstrapValidator({
        ...
        e.preventDefault();
        $.post('save-maxPrice-ajax', $("#addform").serialize(), function(result) {
        	if (result.trim() != "") {
				errorMessage();
