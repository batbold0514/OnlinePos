...
<script type="text/javascript" src="../js/page-js/article-new-2.js"></script>
...
<div class="panel panel-success" id="mainPanel">
	<div class="panel-heading">
		<h3 class="panel-title text-center">
			...
			<s:text name="addProduct" />
		</h3>
	</div>
	<div class="panel-body">
		<s:form action="saveArticle" cssClass="form-horizontal">
		<fieldset>
							...
							<div class="col-sm-7 col-lg-6">
								<div class="input-group">
									...
									<span class="input-group-btn">
	        							<a class="btn btn-sm btn-addon input-sm" id="customerAdd">
...
<div id="add-customer-dialog" title="Харилцагч нэмэх">
	<form>
		<label for="customerName">Харилцагчийн нэр</label>
