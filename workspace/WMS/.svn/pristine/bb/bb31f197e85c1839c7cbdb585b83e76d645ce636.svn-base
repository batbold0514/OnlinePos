	...
	<div class="panel-heading">
		<h3 class="panel-title text-center">
			...
			<s:if test="id == null">
				...
				<s:text name="editCustomer" />
			</s:else>
		</h3>
	</div>
	<div class="panel-body">
		<s:form action="save-customer" method="POST" cssClass="form-horizontal">
			<s:hidden key="id" />
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="col-sm-7 col-lg-6">
							<s:textfield key="name" cssClass="form-control" id="name" autofocus="" />
						</div>
					</div>
				</div>
				<div class="row">
			...
			<div class="form-group">
				<div class="col-sm-offset-1 col-sm-3 col-lg-offset-2 col-lg-2">
					<a href="customer-list" class="btn btn-back btn-block">
				...
				<div class="col-sm-4">
					<button type="submit" id="saveCustomer" class="btn btn-success btn-block">
