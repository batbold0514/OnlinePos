...
<div class="panel panel-success" id="mainPanel">
	...
	<div class="panel-body">
		<s:form action="userSave" method="POST" cssClass="form-horizontal">
			<s:hidden key="id" />
					...
					<div class="col-sm-12">
						...
						<div class="col-sm-7 col-lg-6">
							<div class="input-group">
								...
								<s:password key="pwd" cssClass="form-control" id="pwd" value="" />
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-sm-12">
						...
						<div class="col-sm-7 col-lg-6">
							<div class="input-group">
								...
								<s:password key="confirmPwd" cssClass="form-control" id="confirmPwd" value="" />
								<span class="input-group-addon">
