...
<table style="font-size: 11">
	...
	<s:iterator value="ServiceList">
		<tr>
			...
			<td><s:property value="servicePrice.code" /></td>
...
<s:if test= "%{#session.spSession.listOfPayment.size >0}">
<table style="font-size: 11">
	<tr>
		<td>Огноо</td>
	...
	<s:iterator value="payments">
		<tr>
			<td><s:date name="savedDate" format="yyyy-MM-dd HH:mm:ss" /></td>
			<td><s:property value="paymentNumber" /></td>
