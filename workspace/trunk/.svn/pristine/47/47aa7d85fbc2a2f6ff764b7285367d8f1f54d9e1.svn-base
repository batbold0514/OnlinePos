...
<div class="page-content">
	...
	<div class="row">
		<div class="col-sm-12">
			<s:form action="editDoctorSessionNext" id="id1"
					...
					<div class="form-group">
						...
						<div class="col-sm-4 col-lg-4">
							<s:select label="%{getText('listOfService')}" id="ls"
								...
								data-placeholder="Үйлчилгээ сонгоно уу" />
						</div>
						<div class="row">
				...
				<div class="row">
					<div class="form-group">
						...
						<div class="row">
							<s:fielderror name="listOfDiagnosis.id" />
						</div>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="col-lg-offset-5 col-sm-offset-5 col-sm-12">
						...
						<s:submit cssClass="btn btn-info col-sm-1 col-lg-1"
							action="sessionNextEdit" value="Дараах">
						</s:submit>
						<%
							}
						%>
