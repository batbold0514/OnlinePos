...
<div class="row">
	<p class="active_menu hide">showProject</p>
	<div class="form-group col-sm-12">
		<label class="control-label col-sm-2" for="projectName"> <s:text
				name="projectName" />
		</label>
		<div class="col-sm-8">
			<s:textfield name="projectName" cssClass="form-control" value="%{#session.project.projectName}" />
		</div>
	</div>
	<div class="form-group col-sm-12">
		...
		<div class="col-sm-8">
			<s:select name="projectManagerId" list="employees" listKey="id"
				...
				headerValue="" value="%{#session.project.projectManager.id}"></s:select>
		</div>
	</div>
	<div class="form-group col-sm-12">
		...
		<div class="col-sm-3">
			<s:textfield name="startDateStr" cssClass="date form-control" value="%{#session.project.startDate}"/>
		</div>
		<label class="control-label col-sm-2" for="endDateStr"> <s:text
				name="endDate" />
		</label>
		<div class="col-sm-3">
			<s:textfield name="endDateStr" cssClass="date form-control" value="%{#session.project.endDate}" />
		</div>
	</div>
	<div class="form-group col-sm-12">
		...
		<div class="col-sm-8">
			<s:textarea name="projectGoal" rows="5" cssClass="form-control" value="%{#session.project.projectGoal}"/>
		</div>
	</div>
	<div class="form-group col-sm-12">
		...
		<div class="col-sm-8">
			<s:select list="employees" name="members" listKey="id"
				...
				cssClass="form-control select" multiple="true" value="%{#session.project.members.id}"></s:select>
		</div>
	</div>
</div>
<div class="row">
...
<div>
	<button class="btn btn-gray"><s:text name="save"/></button>
</div>
