...
<div class="row">
	<div class="col-sm-12">
		<h3 class="page-title">
			<s:text name="registerSearch" />
		</h3>
	</div>
	<p class="active_menu hide">registerSearch</p>
	<div class="row col-sm-12">
		<s:form action="search-register">
			<label for="registerStr" class="control-label"><s:text
					name="search" /> </label>
			<s:textfield name="registerStr" />
	...
	<div class="portlet box blue">
		...
		<div class="portlet-body">
			<div id="list-result">
				<display:table name="customerList" id="regSearchTbl"
...
<script src="../js/PageJS/search-register.js"></script>