...
<div class="row">
	<div class="col-sm-12">
		<h3 class="page-title">
			<s:text name="carPrice" />
		</h3>
	</div>
	<p class="active_menu hide">carPrice</p>
	<div class="portlet box blue">
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-home"> <s:text name="carPrice" /></i>
			</div>
			<div class="tools">
		...
		<div class="portlet-body">
			<div class="table-toolbar col-sm-12">
				<div class="col-sm-8">
					<s:form action="search-carprice" id="searchCarPriceForm">
						<div class="row">
							...
							<div class="col-sm-2">
								<s:textfield name="date1" size="1" />
								<s:textfield name="date2" size="1" />
							</div>
						</div>
						<div class="row">
...
<script src="../js/PageJS/carprice.js"></script>