...
function pageScript() {
	$("#numberSearchTbl th:nth-child(1), #numberSearchTbl td:nth-child(1)").hide();
	...
	$("#numberSearchTbl tbody tr").click(function(e) {
	...
	$("#numberSearchTbl tbody tr").dblclick(function(e) {
		position1 = oTable1.fnGetPosition(this);
		id1 = oTable1.fnGetData(position1)[0];
		name = oTable1.fnGetData(position1)[1];
		address = oTable1.fnGetData(position1)[2];
