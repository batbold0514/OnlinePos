...
<meta name="keywords" content="Estimator">
...
<link rel="stylesheet" type="text/css"
	href="../assets/plugins/clockface/css/clockface.css" />
...
<link href="../assets/jquery-ui.structure.css" rel="stylesheet"
	type="text/css" />
...
<!-- BEGIN PAGE LEVEL PLUGINS -->
<script src="../assets/plugins/bootbox/bootbox.min.js"
	type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
...
<script type="text/javascript"
	src="../assets/scripts/jquery.jplayer.min.js"></script>
...
<script type="text/javascript"
	src="../assets/plugins/jquery.pulsate.min.js"></script>
<%-- <script
	src="../assets/plugins/bootstrap-switch/static/js/bootstrap-switch.min.js"
	type="text/javascript"></script> --%>
<script src="../js/metronic.js"></script>
<link href="../assets/css/components.css" id="style_components"
	rel="stylesheet" type="text/css" />
<script src="../js/autocomplete/selectize.js" type="text/javascript"></script>
<script src="../js/autocomplete/index.js" type="text/javascript"></script>
<link href="../dist/css/selectize.default.css" rel="stylesheet" type="text/css" />
<script src="../js/calculator/zeninput.js" type="text/javascript"></script>
<!-- file upload start-->
...
<script>
	...
	function active_menu() {
		var s = document.getElementsByClassName("active_menu");
		$("#" + s[0].innerHTML).addClass('active');
		$("#" + s[0].innerHTML).parents('li').addClass("active");
		$("#" + s[0].innerHTML).parents('li').find('a').children("span.arrow")
				.addClass("open");
		$("#" + s[0].innerHTML).parents('li').find('a').children(
				"span.selectedd").addClass("selected");
	}
</script>
<!-- END JAVASCRIPTS -->
...
<%-- <body>
	<div id="main-container">
		...
		<div class="page-sidebar nav-collapse" id="sidebar">
