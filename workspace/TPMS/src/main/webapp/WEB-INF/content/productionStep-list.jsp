...
<div id="dialog-addnew" class="hide">
	<s:form action="saveProductionStep" cssClass="form-horizontal"
		id="addForm">
		<s:hidden name="id" />
		<div class="form-group">
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="col-sm-7 col-lg-6">
						<s:textfield name="name" cssClass="form-control" id="pname"
							autofocus="" />
					</div>
				</div>
			</div>
...
<script src="../js/PageJS/productionStepList.js"></script>