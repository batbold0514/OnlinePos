...
<div class="hidden" id="page">
	<s:url action="bonusList" includeParams="none"/>
</div>
<div class="page-content">
	<div class="page-header">
		<h2>
			<s:text name="BonusList" />
...
<div id="dialog-show" class="hide">
	...
	<div class="form-group">
		<div class="row">
			<div class="col-sm-12">
				<label for="value" class="control-label col-sm-5 col-lg-5">
					<s:text name="value" />
				</label>
				<div class="col-sm-7 col-lg-6">
...
<div id="dialog-addnew" class="hide">
	<s:form action="saveBonus" cssClass="form-horizontal" id="addForm">
		<s:hidden name="id" />
		<div class="form-group">
			<div class="row">
				<div class="col-sm-12">
...
<script src="../js/PageJS/bonusList.js"></script>