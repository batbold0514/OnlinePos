				...
				.dataTable(
						{
							"fnFooterCallback" : function(nRow, aaData, iStart,
								...
								var nCells2 = document.getElementById("defTotal");
								nCells2.innerHTML = CommaFormatted(defTotal);
							},
				...
				.dataTable(
						{
							"fnFooterCallback" : function(nRow, aaData, iStart,
								...
								nCells1.innerHTML = CommaFormatted(sellprice);
								var nCells2 = document
								.getElementById('defTotalFinish');
								nCells2.innerHTML = CommaFormatted(defTotal);
							},
							"sDom" : "<'row'<'col-xs-4'l><'col-xs-4'f><'col-xs-4'T>r>t<'row'<'col-xs-4 customTool'><'col-xs-4'i><'col-xs-4'p>>",
							"aaSorting" : [ [ 0, "asc" ] ],
				...
				.dataTable(
						{
							"fnFooterCallback" : function(nRow, aaData, iStart,
								...
								nCells1.innerHTML = CommaFormatted(sellprice);
								var nCells1 = document
								.getElementById('defTotalUnFinish');
								nCells1.innerHTML = CommaFormatted(defTotal);
							},
							"sDom" : "<'row'<'col-xs-4'l><'col-xs-4'f><'col-xs-4'T>r>t<'row'<'col-xs-4 customTool'><'col-xs-4'i><'col-xs-4'p>>",
							"aaSorting" : [ [ 0, "asc" ] ],
							"oLanguage" : {
