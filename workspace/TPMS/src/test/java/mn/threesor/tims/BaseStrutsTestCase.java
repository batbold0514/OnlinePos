...
public class BaseStrutsTestCase<T> extends
		AbstractModelServiceSpringContextTest {
	private static final String CONFIG_LOCATIONS = "classpath:/spring-context-tims.xml";
	...
	*//**
	...
	protected void onsetUp() throws Exception {
		...
		params.put("actionPackages", "mn.threesor.tims.action");
